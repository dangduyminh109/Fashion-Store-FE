  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const data: DashboardResponse = response.data.result;
        setData(data);
      } catch (error) {
        toast.error("Tải dữ liệu không thành công! vui lòng reload lại trang hoặc thử lại sau!");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <Fragment>
      ...
      {!loading && !data && (
        ...
        >
          <Typography variant="h3">Tải dử liệu thất bại</Typography>
        </Box>
      )}
      ...
      {!loading && data && (
        <Fragment>
          ...
          <Grid container mt={4} spacing={4}>
            ...
            >
              <Typography variant="body1">Doanh thu theo tháng</Typography>
              <Box
                sx={{
                  height: "280px",
                }}
            ...
            >
              <Typography variant="body1">Danh mục bán chạy</Typography>
              <Box
                sx={{
                  height: "300px",
                }}
            ...
            >
              ...
              >
                <Link to="/admin/customers">Xem thêm</Link>
            ...
            >
              ...
              <CardContent sx={{ p: 0 }}>
                <TableContainer
                  component={Paper}
                  sx={{ maxHeight: "250px", overflow: "auto", boxShadow: "none" }}
                >
                  <Table sx={{ minWidth: 600 }} aria-label="Đơn hàng gần đây">
                    <TableHead>
                      <TableRow>
