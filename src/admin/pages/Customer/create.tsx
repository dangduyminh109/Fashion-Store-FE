...
import { createSchema as schema } from "~/admin/schemas/customerSchema";
...
function Create() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.data.code == 1000) {
        navigate("/admin/customers", { state: { message: res.data.message } });
        return;
      }
  ...
  return (
    <Fragment>
      <Breadcrumb listBreadcrumb={listBreadcrumb} title="Tạo Mới Customer" />
      <form onSubmit={handleSubmit(onSubmit, onError)}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 3 }}>
          <Button variant="outlined" size="large" onClick={() => navigate("/admin/customers")}>
            Quay Lại
          </Button>
