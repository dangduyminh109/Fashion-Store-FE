...
import schema from "~/admin/schemas/roleSchema";
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.data.code == 1000) {
        navigate("/admin/user/roles", { state: { message: res.data.message } });
        return;
      }
    ...
    <Fragment>
      ...
      {!loading && (
        <form onSubmit={handleSubmit(onSubmit, onError)}>
          ...
          >
            <Button variant="outlined" size="large" onClick={() => navigate("/admin/user/roles")}>
              Quay Lại
            </Button>
