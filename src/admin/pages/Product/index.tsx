...
import type ProductResponse from "~/admin/types/product";
import { fetchProduct, deleteOrRestore, updateStatus } from "~/admin/features/product/productApi";
  ...
  return (
    <Fragment>
      ...
      <Toolbar
        ...
        trash={trash}
        createPath="/admin/product/create"
      />
