...
function Create() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.data.code == 1000) {
        navigate("/admin/products", { state: { message: res.data.message } });
        return;
      }
  ...
  return (
    <Fragment>
      <Breadcrumb listBreadcrumb={listBreadcrumb} title="Tạo Mới Sản Phẩm" />
      {loading && (
        <Box
          sx={{
            with: "100%",
                ...
                {listImage.length < 12 && (
                  <>
                    ...
                    >
                      ...
                      />
                      <Typography variant="body2">{listImage.length}/12 ảnh</Typography>
                    </Grid>
                  </>
                )}
